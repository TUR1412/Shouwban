...
**开发职责:** 本项目由 AI (Gemini) 负责完成全部前端代码 (HTML, CSS, JavaScript) 的编写与实现。**天帝 (用户) 负责提供所有必要的视觉素材（图片、Logo）、最终文案内容，并在后续阶段提供后端 API 接口定义与数据结构。** 本文档作为前端开发的主要指导。
