...
function assertRequiredRepoFilesExist() {
  const required = [
    ...
    'scripts/modules/telemetry.js',
    'scripts/modules/diagnostics.js',
    'scripts/modules/command-palette.js',
...
function assertServiceWorkerVersionMatches(version) {
  ...
  const expected = [
    ...
    `scripts/modules/telemetry.js?v=${version}`,
    `scripts/modules/diagnostics.js?v=${version}`,
    `scripts/modules/command-palette.js?v=${version}`,
