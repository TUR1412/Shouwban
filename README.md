...
```powershell
pwsh -NoLogo -NoProfile -Command 'node scripts/bump-version.mjs 20251220.3000'
```

或使用 `npm`：

```powershell
pwsh -NoLogo -NoProfile -Command 'npm run bump:version -- 20251220.3000'
```
...
夸克级 4000 次迭代记录：见 `QUARK_ITERATIONS.md`。
